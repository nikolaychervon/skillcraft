...
/**
 * @extends AbstractRequestDataAssembler<ChangeUserPasswordRequestData>
 */
class ChangeUserPasswordRequestDataAssembler extends AbstractRequestDataAssembler
{
    protected function getRequestDataClass(): string
    {
        return ChangeUserPasswordRequestData::class;
    }
}
