...
/**
 * @extends AbstractRequestDataAssembler<LoginUserRequestData>
 */
class LoginUserRequestDataAssembler extends AbstractRequestDataAssembler
{
    protected function getRequestDataClass(): string
    {
        return LoginUserRequestData::class;
    }
}
